        ...
        filteredProducts() {
            return this.products.filter((product) => {
                return product.name.indexOf(this.searchKey) > -1
                    ...
                    || product.place_storage.toString().indexOf(this.searchKey) > -1
                    || product.create_date.Date.indexOf(this.searchKey) > -1
...
var AddProduct = Vue.extend({
    ...
    data() {
        return {
            product: {name: '', description: '', place_storage:0, create_date:'', price: 0}
        }
    },
    methods: {
        createProduct() {
